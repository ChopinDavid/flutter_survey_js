...
import "expressions.dart"
    show Const, BinaryOperand, Variable, Operand, UnaryOperand, FunctionOperand, ArrayOperand;

abstract class Expectation {
  late String type;

 late String text;
 late bool ignoreCase;
}

abstract class IFilePosition {
  num? offset;
...
abstract class IFileRange {
  IFilePosition? start;

  IFilePosition? end;
}

abstract class ILiteralExpectation extends Expectation {
  @override
  String type = 'literal';

}

abstract class IClassParts
    implements List<dynamic /* String | IClassParts */> {}

abstract class IClassExpectation extends Expectation {
  @override
  String type = 'class'
...
abstract class IAnyExpectation extends Expectation {
  @override
  String type = 'any'
...
abstract class IEndExpectation extends Expectation {
  @override
  String type = 'end'
...
abstract class IOtherExpectation extends Expectation {
  @override
  String type = 'other';
...
class SyntaxError extends Error {
  static buildMessage(List<Expectation> expected,
    ...
    String literalEscape(String s) {
      return s.replaceFirst(new RegExp (r'\\'), "\\\\").replaceFirst(
          new RegExp (r'"'), "\\\"").replaceFirst(new RegExp (r'\0'), "\\0").replaceFirst(
          new RegExp (r'\t'), "\\t").replaceFirst(new RegExp (r'\n'), "\\n").replaceFirst(
          new RegExp (r'\r'), "\\r").replaceFirstMapped(
          new RegExp (r'[\x00-\x0F]'), (ch) => "\\x0" + hex(ch.input)).replaceFirstMapped(
          new RegExp (r'[\x10-\x1F\x7F-\x9F]'), (ch) => "\\x" + hex(ch.input));
    }
    String classEscape(String s) {
      return s.replaceFirst(new RegExp (r'\\'), "\\\\").replaceFirst(
          new RegExp (r'\]'), "\\]").replaceFirst(new RegExp (r'\^'), "\\^").replaceFirst(
          new RegExp (r'-'), "\\-").replaceFirst(new RegExp (r'\0'), "\\0").replaceFirst(
          new RegExp (r'\t'), "\\t").replaceFirst(new RegExp (r'\n'), "\\n").replaceFirst(
          new RegExp (r'\r'), "\\r").replaceFirstMapped(
          new RegExp (r'[\x00-\x0F]'), (ch) => "\\x0" + hex(ch.input)).replaceFirstMapped(
    ...
    describeExpectation(Expectation expectation) {
      switch (expectation.type) {
        ...
        case "class" :
          final escapedParts = (expectation as IClassExpectation).parts?.map((part) {
            return part is List
                ? classEscape(part[0] as String) + "-" + classEscape(part[1] as String)
                : classEscape(part);
          });
          String str = "[" + ((expectation as IClassExpectation).inverted ? "^" : "");
          escapedParts?.forEach((element) {str += element;});
          str += "]";
          return str;
        case "any" :
    ...
    describeExpected(List <Expectation> expected1) {
      ...
      switch (descriptions.length) {
        ...
        default :
          return descriptions.sublist(0, -1).join(", ") + ", or " +
  ...
  SyntaxError(this.message, this.expected,
      this.found, this.location) : super () {
...
peg$parse(String input, [ IParseOptions options ]) {
  options = !identical(options, undefined) ? options : {};
  final Readonly<dynamic> peg$FAILED = {};
  ...
  expected(String description, [ IFileRange location1 ]) {
    location1 =
    !identical(location1, undefined) ? location1 : peg$computeLocation(
  ...
  IClassExpectation peg$classExpectation(IClassParts parts, bool inverted,
      bool ignoreCase) {
    return {
      "type": "class",
      "parts": parts,
  ...
  peg$computePosDetails(num pos) {
    ...
    if (details) {
      ...
      while (p < pos) {
        if (identical(input.charCodeAt(p), 10)) {
          details.line ++;
          details.column = 1;
        } else {
          details.column ++;
  ...
  IFileRange peg$computeLocation(num startPos, num endPos) {
  ...
  peg$buildStructuredError(List <Expectation> expected1,
    ...
    return new SyntaxError (
        SyntaxError.buildMessage(expected1, found), expected1, found,
        location1);
  }
  ...
  dynamic peg$parseOrSign() {
    ...
    s0 = peg$currPos;
    if (identical(input.substr(peg$currPos, 2), peg$c1)) {
      s1 = peg$c1;
      peg$currPos += 2;
    } else {
      s1 = peg$FAILED;
    ...
    if (identical(s1, peg$FAILED)) {
      if (identical(input.substr(peg$currPos, 2).toLowerCase(), peg$c3)) {
  ...
  dynamic peg$parseAndSign() {
    ...
    s0 = peg$currPos;
    if (identical(input.substr(peg$currPos, 2), peg$c6)) {
      s1 = peg$c6;
      peg$currPos += 2;
    } else {
      s1 = peg$FAILED;
    ...
    if (identical(s1, peg$FAILED)) {
      if (identical(input.substr(peg$currPos, 3).toLowerCase(), peg$c8)) {
  ...
  dynamic peg$parseComparableOperators() {
    ...
    s0 = peg$currPos;
    if (identical(input.substr(peg$currPos, 2), peg$c12)) {
      s1 = peg$c12;
      peg$currPos += 2;
    } else {
      s1 = peg$FAILED;
    ...
    if (identical(s1, peg$FAILED)) {
      if (identical(input.substr(peg$currPos, 11).toLowerCase(), peg$c14)) {
    ...
    if (identical(s0, peg$FAILED)) {
      s0 = peg$currPos;
      if (identical(input.substr(peg$currPos, 2), peg$c17)) {
        s1 = peg$c17;
        peg$currPos += 2;
      } else {
        s1 = peg$FAILED;
      ...
      if (identical(s1, peg$FAILED)) {
        if (identical(input.substr(peg$currPos, 14).toLowerCase(), peg$c19)) {
      ...
      if (identical(s0, peg$FAILED)) {
        s0 = peg$currPos;
        if (identical(input.substr(peg$currPos, 2), peg$c22)) {
          s1 = peg$c22;
          peg$currPos += 2;
        } else {
          s1 = peg$FAILED;
        ...
        if (identical(s1, peg$FAILED)) {
          if (identical(input.substr(peg$currPos, 5).toLowerCase(), peg$c24)) {
        ...
        if (identical(s0, peg$FAILED)) {
          s0 = peg$currPos;
          if (identical(input.charCodeAt(peg$currPos), 61)) {
            s1 = peg$c27;
            peg$currPos ++;
          } else {
            s1 = peg$FAILED;
          ...
          if (identical(s0, peg$FAILED)) {
            s0 = peg$currPos;
            if (identical(input.substr(peg$currPos, 2), peg$c29)) {
              s1 = peg$c29;
              peg$currPos += 2;
            } else {
              s1 = peg$FAILED;
            ...
            if (identical(s1, peg$FAILED)) {
              if (identical(
                  input.substr(peg$currPos, 8).toLowerCase(), peg$c31)) {
            ...
            if (identical(s0, peg$FAILED)) {
              s0 = peg$currPos;
              if (identical(input.charCodeAt(peg$currPos), 60)) {
                s1 = peg$c34;
                peg$currPos ++;
              } else {
                s1 = peg$FAILED;
              ...
              if (identical(s1, peg$FAILED)) {
                if (identical(
                    input.substr(peg$currPos, 4).toLowerCase(), peg$c36)) {
              ...
              if (identical(s0, peg$FAILED)) {
                s0 = peg$currPos;
                if (identical(input.charCodeAt(peg$currPos), 62)) {
                  s1 = peg$c39;
                  peg$currPos ++;
                } else {
                  s1 = peg$FAILED;
                ...
                if (identical(s1, peg$FAILED)) {
                  if (identical(
                      input.substr(peg$currPos, 7).toLowerCase(), peg$c41)) {
  ...
  dynamic peg$parsePlusMinusSigns() {
    ...
    s0 = peg$currPos;
    if (identical(input.charCodeAt(peg$currPos), 43)) {
      s1 = peg$c44;
      peg$currPos ++;
    } else {
      s1 = peg$FAILED;
    ...
    if (identical(s0, peg$FAILED)) {
      s0 = peg$currPos;
      if (identical(input.charCodeAt(peg$currPos), 45)) {
        s1 = peg$c47;
        peg$currPos ++;
      } else {
        s1 = peg$FAILED;
  ...
  dynamic peg$parseMulDivSigns() {
    ...
    s0 = peg$currPos;
    if (identical(input.charCodeAt(peg$currPos), 42)) {
      s1 = peg$c50;
      peg$currPos ++;
    } else {
      s1 = peg$FAILED;
    ...
    if (identical(s0, peg$FAILED)) {
      s0 = peg$currPos;
      if (identical(input.charCodeAt(peg$currPos), 47)) {
        s1 = peg$c53;
        peg$currPos ++;
      } else {
        s1 = peg$FAILED;
      ...
      if (identical(s0, peg$FAILED)) {
        s0 = peg$currPos;
        if (identical(input.charCodeAt(peg$currPos), 37)) {
          s1 = peg$c56;
          peg$currPos ++;
        } else {
          s1 = peg$FAILED;
  ...
  dynamic peg$parsePowerSigns() {
    ...
    s0 = peg$currPos;
    if (identical(input.charCodeAt(peg$currPos), 94)) {
      s1 = peg$c59;
      peg$currPos ++;
    } else {
      s1 = peg$FAILED;
    ...
    if (identical(s1, peg$FAILED)) {
      if (identical(input.substr(peg$currPos, 5).toLowerCase(), peg$c61)) {
        s1 = input.substr(peg$currPos, 5);
        peg$currPos += 5;
      } else {
        s1 = peg$FAILED;
  ...
  dynamic peg$parseBinFunctions() {
    ...
    s0 = peg$currPos;
    if (identical(input.substr(peg$currPos, 2), peg$c64)) {
      s1 = peg$c64;
      peg$currPos += 2;
    } else {
      s1 = peg$FAILED;
    ...
    if (identical(s1, peg$FAILED)) {
      if (identical(input.substr(peg$currPos, 8).toLowerCase(), peg$c66)) {
        s1 = input.substr(peg$currPos, 8);
        peg$currPos += 8;
      } else {
        s1 = peg$FAILED;
      ...
      if (identical(s1, peg$FAILED)) {
        if (identical(input.substr(peg$currPos, 7).toLowerCase(), peg$c68)) {
          s1 = input.substr(peg$currPos, 7);
          peg$currPos += 7;
        } else {
          s1 = peg$FAILED;
    ...
    if (identical(s0, peg$FAILED)) {
      s0 = peg$currPos;
      if (identical(input.substr(peg$currPos, 11).toLowerCase(), peg$c71)) {
        s1 = input.substr(peg$currPos, 11);
        peg$currPos += 11;
      } else {
        s1 = peg$FAILED;
      ...
      if (identical(s1, peg$FAILED)) {
        if (identical(input.substr(peg$currPos, 10).toLowerCase(), peg$c73)) {
      ...
      if (identical(s0, peg$FAILED)) {
        s0 = peg$currPos;
        if (identical(input.substr(peg$currPos, 5).toLowerCase(), peg$c76)) {
          s1 = input.substr(peg$currPos, 5);
          peg$currPos += 5;
        } else {
          s1 = peg$FAILED;
        ...
        if (identical(s0, peg$FAILED)) {
          s0 = peg$currPos;
          if (identical(input.substr(peg$currPos, 5).toLowerCase(), peg$c79)) {
            s1 = input.substr(peg$currPos, 5);
            peg$currPos += 5;
          } else {
            s1 = peg$FAILED;
  ...
  Operand peg$parseFactor() {
    ...
    s0 = peg$currPos;
    if (identical(input.charCodeAt(peg$currPos), 40)) {
      s1 = peg$c82;
      peg$currPos ++;
    } else {
      s1 = peg$FAILED;
    ...
    if (!identical(s1, peg$FAILED)) {
      ...
      if (!identical(s2, peg$FAILED)) {
        ...
        if (!identical(s3, peg$FAILED)) {
          s4 = peg$parse_();
          if (!identical(s4, peg$FAILED)) {
            if (identical(input.charCodeAt(peg$currPos), 41)) {
              s5 = peg$c84;
              peg$currPos ++;
            } else {
              s5 = peg$FAILED;
  ...
  dynamic peg$parseUnaryFunctionOp() {
    ...
    s0 = peg$currPos;
    if (identical(input.charCodeAt(peg$currPos), 33)) {
      s1 = peg$c88;
      peg$currPos ++;
    } else {
      s1 = peg$FAILED;
    ...
    if (identical(s1, peg$FAILED)) {
      if (identical(input.substr(peg$currPos, 6).toLowerCase(), peg$c90)) {
  ...
  dynamic peg$parseUnFunctions() {
    ...
    s0 = peg$currPos;
    if (identical(input.substr(peg$currPos, 5).toLowerCase(), peg$c94)) {
      s1 = input.substr(peg$currPos, 5);
      peg$currPos += 5;
    } else {
      s1 = peg$FAILED;
    ...
    if (identical(s0, peg$FAILED)) {
      s0 = peg$currPos;
      if (identical(input.substr(peg$currPos, 8).toLowerCase(), peg$c97)) {
        s1 = input.substr(peg$currPos, 8);
        peg$currPos += 8;
      } else {
        s1 = peg$FAILED;
  ...
  dynamic peg$parseAtom() {
    ...
    s1 = peg$parse_();
    if (!identical(s1, peg$FAILED)) {
      if (identical(input.substr(peg$currPos, 9), peg$c100)) {
        s2 = peg$c100;
        peg$currPos += 9;
      } else {
        s2 = peg$FAILED;
      ...
      if (identical(s2, peg$FAILED)) {
        if (identical(input.substr(peg$currPos, 4), peg$c102)) {
          s2 = peg$c102;
          peg$currPos += 4;
        } else {
          s2 = peg$FAILED;
    ...
    if (identical(s0, peg$FAILED)) {
      ...
      if (identical(s0, peg$FAILED)) {
        ...
        s1 = peg$parse_();
        if (!identical(s1, peg$FAILED)) {
          if (identical(input.charCodeAt(peg$currPos), 123)) {
            s2 = peg$c106;
            peg$currPos ++;
          } else {
            s2 = peg$FAILED;
          ...
          if (!identical(s2, peg$FAILED)) {
            ...
            if (!identical(s3, peg$FAILED)) {
              if (identical(input.charCodeAt(peg$currPos), 125)) {
                s4 = peg$c108;
                peg$currPos ++;
              } else {
                s4 = peg$FAILED;
  ...
  dynamic peg$parseConstValue() {
    ...
    if (identical(s0, peg$FAILED)) {
      ...
      if (identical(s0, peg$FAILED)) {
        ...
        if (identical(s0, peg$FAILED)) {
          s0 = peg$currPos;
          if (identical(input.substr(peg$currPos, 2), peg$c112)) {
            s1 = peg$c112;
            peg$currPos += 2;
          } else {
            s1 = peg$FAILED;
          ...
          if (identical(s0, peg$FAILED)) {
            s0 = peg$currPos;
            if (identical(input.substr(peg$currPos, 2), peg$c115)) {
              s1 = peg$c115;
              peg$currPos += 2;
            } else {
              s1 = peg$FAILED;
            ...
            if (identical(s0, peg$FAILED)) {
              s0 = peg$currPos;
              if (identical(input.charCodeAt(peg$currPos), 39)) {
                s1 = peg$c117;
                peg$currPos ++;
              } else {
                s1 = peg$FAILED;
              ...
              if (identical(s0, peg$FAILED)) {
                s0 = peg$currPos;
                if (identical(input.charCodeAt(peg$currPos), 34)) {
                  s1 = peg$c120;
                  peg$currPos ++;
                } else {
                  s1 = peg$FAILED;
  ...
  dynamic peg$parseArrayOp() {
    ...
    s0 = peg$currPos;
    if (identical(input.charCodeAt(peg$currPos), 91)) {
      s1 = peg$c122;
      peg$currPos ++;
    } else {
      s1 = peg$FAILED;
    ...
    if (!identical(s1, peg$FAILED)) {
      ...
      if (!identical(s2, peg$FAILED)) {
        if (identical(input.charCodeAt(peg$currPos), 93)) {
          s3 = peg$c124;
          peg$currPos ++;
        } else {
          s3 = peg$FAILED;
  ...
  ArrayOperand peg$parseSequence() {
    var s0, s1, s2, s3, s4, s5, s6, s7;
    ...
    if (!identical(s1, peg$FAILED)) {
      ...
      s4 = peg$parse_();
      if (!identical(s4, peg$FAILED)) {
        if (identical(input.charCodeAt(peg$currPos), 44)) {
          s5 = peg$c127;
          peg$currPos ++;
        } else {
          s5 = peg$FAILED;
  ...
  dynamic peg$parseLogicValue() {
    ...
    s0 = peg$currPos;
    if (identical(input.substr(peg$currPos, 4).toLowerCase(), peg$c130)) {
      s1 = input.substr(peg$currPos, 4);
      peg$currPos += 4;
    } else {
      s1 = peg$FAILED;
    ...
    if (identical(s0, peg$FAILED)) {
      s0 = peg$currPos;
      if (identical(input.substr(peg$currPos, 5).toLowerCase(), peg$c133)) {
        s1 = input.substr(peg$currPos, 5);
        peg$currPos += 5;
      } else {
        s1 = peg$FAILED;
  ...
  dynamic peg$parseArithmeticValue() {
    ...
    s0 = peg$currPos;
    if (identical(input.substr(peg$currPos, 2), peg$c136)) {
      s1 = peg$c136;
      peg$currPos += 2;
    } else {
      s1 = peg$FAILED;
  ...
  dynamic peg$parseNumber() {
    ...
    s1 = peg$parseDigits();
    if (!identical(s1, peg$FAILED)) {
      if (identical(input.charCodeAt(peg$currPos), 46)) {
        s2 = peg$c142;
        peg$currPos ++;
      } else {
        s2 = peg$FAILED;
    ...
    if (identical(s0, peg$FAILED)) {
      ...
      if (identical(s0, peg$FAILED)) {
        s0 = peg$currPos;
        if (identical(input.charCodeAt(peg$currPos), 48)) {
          s1 = peg$c146;
          peg$currPos ++;
        } else {
          s1 = peg$FAILED;
  ...
  dynamic peg$parseAnyCharacters() {
    ...
    s0 = peg$currPos;
    if (identical(input.substr(peg$currPos, 2), peg$c150)) {
      s1 = peg$c150;
      peg$currPos += 2;
    } else {
      s1 = peg$FAILED;
    ...
    if (identical(s0, peg$FAILED)) {
      s0 = peg$currPos;
      if (identical(input.substr(peg$currPos, 2), peg$c153)) {
        s1 = peg$c153;
        peg$currPos += 2;
      } else {
        s1 = peg$FAILED;
  ...
  buildBinaryOperand(Operand head, Array<dynamic> tail,
  ...
  Array<dynamic> flattenArray(Array<dynamic> array) {
  ...
  if (!identical(peg$result, peg$FAILED) &&
    ...
    throw peg$buildStructuredError(peg$maxFailExpected,
        ...
        peg$maxFailPos < input.length ? peg$computeLocation(
            peg$maxFailPos, peg$maxFailPos + 1) : peg$computeLocation(
            peg$maxFailPos, peg$maxFailPos));
  }
}

abstract class IParseOptions {
  String filename;
